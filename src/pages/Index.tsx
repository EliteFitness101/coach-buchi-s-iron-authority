    ...
    <Layout>
      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden">
        ...
        <div className="container-x relative px-4 md:px-8 py-20 animate-fade-up">
          ...
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-bold leading-[0.95] max-w-4xl">
            Build a stronger body through{" "}
            <span className="text-gold-gradient">structure, not guesswork.</span>
          </h1>

          <p className="mt-6 text-lg md:text-xl text-foreground/80 max-w-2xl">
            ResoFlex™ OS combines structured training systems, Nigerian nutrition guidance,
            Coach Buchi's transformation protocols, and Iron Authority equipment into one
            premium performance ecosystem.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-gold text-foreground hover:bg-primary hover:text-primary-foreground"
            >
              <Link to="/shop">
                Explore Iron Authority Equipment
              </Link>
            </Button>
          ...
          <div className="mt-4 text-xs text-muted-foreground tracking-wide">
            Powered by ResoFlex™ OS · Personalized in under 60 seconds
          </div>
        ...
        <div className="container-x grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-foreground/80 mb-4">
              ...
              Featured in GQ Africa & BellaNaija.
            </p>

            <p className="text-muted-foreground mb-6">
              My promise: 90 days of structured discipline and you will not recognize the
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {[
                ...
                <div key={l} className="border border-gold p-4 text-center">
                  <div className="text-2xl font-display text-primary">{n}</div>
      ...
      <section className="section-pad container-x">
        ...
        <p className="text-center text-muted-foreground max-w-2xl mx-auto mb-12">
          From iron to insight — the ResoFlex ecosystem powers your transformation.
        </p>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">

          {[
            { icon: Dumbbell, title: "Hardware Store", desc: "Cast iron dumbbells, barbells, benches & bundles." },
            { icon: Flame, title: "Wellness SaaS", desc: "AI-driven Nigerian fitness protocols." },
            { icon: Zap, title: "Nownowgym App", desc: "Tracking, rewards, QR purchases." },
            { icon: Trophy, title: "Affiliate Engine", desc: "Referral tracking & payouts." },
            { icon: ShieldCheck, title: "Iron Authority Tier", desc: "Elite coaching access." },
            { icon: MapPin, title: "Multi-City Logistics", desc: "Nationwide delivery network." },
          ].map((m) => (
            <div key={m.title} className="glass p-7 rounded-sm hover:gold-glow">
      ...
      <section className="section-pad bg-card/40 border-y border-gold">
        <div className="container-x">
          ...
          <h2 className="font-display text-4xl md:text-5xl text-center mb-12">
            Transformations. <span className="text-gold-gradient">Receipts.</span>
          </h2>

          <div className="grid md:grid-cols-3 gap-6">

            {[
              { name: "Tunde A.", city: "Lagos", quote: "Lost 18kg in 5 months.", result: "-18kg" },
              { name: "Amara O.", city: "Abuja", quote: "Lean muscle transformation.", result: "+12kg" },
              { name: "Chuka E.", city: "PH", quote: "Built home gym.", result: "Owner" },
            ].map((t) => (
              <div key={t.name} className="glass p-7 rounded-sm">
                <Quote className="w-8 h-8 text-primary mb-4" />
                <p className="mb-6">"{t.quote}"</p>
                <div className="flex justify-between border-t border-gold pt-4">
                  <div>
                    <div className="font-semibold">{t.name}</div>
                    <div className="text-xs text-muted-foreground">{t.city}</div>
                  </div>
                  <div className="text-primary font-display">{t.result}</div>
                </div>
              </div>
            ))}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          {[
            ...
            <div key={i}>
              ...
              <div className="text-xs uppercase text-muted-foreground mt-2">
                {s.l}
              </div>
            </div>
          ))}
      ...
      <section className="section-pad container-x">
        ...
        <div className="glass p-10 md:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-primary text-xs uppercase tracking-[0.3em] mb-3">
              Iron Authority Drop · Limited Access
            </p>

            <h2 className="font-display text-4xl md:text-5xl mb-4">
              Begin your transformation system
            </h2>

            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              Start with ChatB2K™ Assessment and receive your ResoFlex™ Protocol.
            </p>

            <Button asChild size="lg" className="bg-gradient-gold text-primary-foreground font-semibold gold-glow">
              <Link to="/assessment">
                Start ChatB2K™ Assessment
                <ArrowRight className="ml-2 w-4 h-4" />
              </Link>
            </Button>
